...
if [ -d “$REPO” ];
then
        echo “La carpeta $REPO si existe y sera eliminada”
        rm -fr $REPO
else
        echo "Se descargara el repositorio"
fi

#Descarga de web

git clone https://github.com/roxsross/$REPO.git
#git clone https://github.com/roxsross/app-295devops-travel  app-295devops-travel
